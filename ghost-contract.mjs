...
export function compileUniversalManifest(manifest={}) {
  ...
  const rules=`Create a clean studio ghost-mannequin product render of the SAME single ${category}; no visible mannequin or human body. Use a completely invisible, anatomically neutral garment support, keeping it hidden while giving the clothing believable three-dimensional volume: visible inner edge depth at the collar or waistband, natural shoulder/seat shape, sidewall thickness, fold gradients, contact shadows and a subtle product-camera perspective. Never make a flat front cutout, technical drawing or 2D icon; no person, skin, head, neck cylinder, torso, limbs, stand or hanger; only the garment and white background may be visible. ${bottom?'Lower garment only, from waistband to hems; never add an upper garment or turn it into a jumpsuit. ':''}Reference garment pixels override all text color names. Preserve photographed hue, saturation, brightness, white balance, texture, cut and lettering. Do not recolor or redesign. `;
