...
const paths=['index.html','app.js','garment-upload.mjs','garment-appearance.mjs','garment-progress.mjs','garment-review.mjs','garment-studio.css','ghost-contract.mjs','ghost-mannequin.mjs','ghost-studio.mjs','ghost-ui.mjs','downloads/clothmatics_ghost_v9.py','downloads/clothmatics_ghost_v9.ipynb'];
...
if(results.some(row=>!row.exactMatch)||gate.status!==401)process.exitCode=1;
